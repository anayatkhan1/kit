...
This Privacy Policy ("Policy") describes how AgentCN ("we", "us", or "our") collects, uses, and protects any personal information you ("User", "you", or "your") provide when using the AgentCN website ("Website").
...
- To improve AgentCN based on user interaction data (collected anonymously via Plausible).
...
- AgentCN is accessible to all, including minors, but it is not specifically targeted at children under 13.
