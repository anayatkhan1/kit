      ...
      <div className="absolute inset-x-4 top-0 mx-auto grid h-[320px] w-[274px] grid-cols-5 grid-rows-6 gap-1 lg:inset-x-12">
        {Array.from({ length: 25 }).map((_, index) => (
          ...
          >
            {index === 6 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-1.svg"
                alt="Part 1"
                width={50}
                height={50}
            ...
            {index === 7 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-2.svg"
                alt="Part 2"
                width={50}
                height={50}
                className="h-full w-full"
            ...
            {index === 8 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-3.svg"
                alt="Part 3"
                width={50}
                height={50}
                className="h-full w-full"
            ...
            {index === 11 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-4.svg"
                alt="Part 4"
                width={50}
                height={50}
                className="h-full w-full"
            ...
            {index === 12 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-5.svg"
                alt="Part 5"
                width={50}
                height={50}
                className="h-full w-full"
            ...
            {index === 13 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-6.svg"
                alt="Part 6"
                width={50}
                height={50}
                className="h-full w-full"
            ...
            {index === 16 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-7.svg"
                alt="Part 7"
                width={50}
                height={50}
                className="h-full w-full"
            ...
            {index === 17 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-8.svg"
                alt="Part 8"
                width={50}
                height={50}
                className="h-full w-full"
            ...
            {index === 18 && (
              <Image
                src="https://cdn.agentcn.dev/images/home-bento/logo-split/part-9.svg"
                alt="Part 9"
                width={50}
                height={50}
                className="h-full w-full"
