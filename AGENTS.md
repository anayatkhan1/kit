...
**Before adding any agent:** read [agent foundation strategy](.agents/skills/build-agent/references/agent-foundation-strategy.md) — one job, 3–5 v1 tools, extension docs over registry sprawl. Use `/add-agent` in Cursor to scope before coding.
...
| Slash command | [`.cursor/commands/add-agent.md`](.cursor/commands/add-agent.md) | `/add-agent` — scope a new agent before coding |
